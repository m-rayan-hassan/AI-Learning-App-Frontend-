    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {statCards.map((stat) => (
          <Card
            key={stat.label}
            className="group border border-border/50 hover:border-primary/30 bg-card hover:shadow-lg transition-all duration-300 overflow-hidden relative"
          >
            ...
            <CardContent className="p-6 flex items-center justify-between relative">
              ...
              <div
                className={`h-11 w-11 ${stat.bg} rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-300`}
              >
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3 border border-border/50 bg-card">
          <CardHeader>
            ...
            <CardDescription>Start learning immediately.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-3">
            ...
            <Link href="/flashcards">
              <Button
                variant="outline"
                className="w-full group border-border/50 hover:border-primary/30"
              >
