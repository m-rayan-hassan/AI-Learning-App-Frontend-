...
export function Navbar() {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 right-0 z-50 w-full border-b border-border/40 bg-background/70 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60"
    >
